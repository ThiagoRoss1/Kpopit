...
const TopButtons = (props: TopButtonsProps) => {
    ...
    const buttonCardStyle = "inline-flex relative sm:w-42 sm:h-12 overflow-hidden rounded-[16px] border-1 border-white/50 bg-transparent backdrop-blur-3xl shadow-[4px_4px_4px_1px_rgba(0,0,0,0.25),inset_0_4px_4px_0_rgba(0,0,0,0.25)]";
    ...
    const centerButtonCardStyle = "inline-flex relative sm:w-48 sm:h-14 overflow-hidden rounded-[20px] p-[1px] focus:outline-none focus:ring-2 focus:ring-[#000000] focus:ring-offset-1 focus:ring-offset-[#242424] backdrop-blur-md shadow-[4px_4px_4px_1px_rgba(0,0,0,0.25),inset_0_4px_4px_0_rgba(0,0,0,0.25)]";
