...
const TopButtons = (props: TopButtonsProps) => {
    ...
    const buttonCardStyle = "inline-flex relative max-xxs:w-20 max-xxs:h-10 xxs:w-25 xxs:h-10 xs:w-28 xs:h-10 sm:w-52 sm:h-13 overflow-hidden rounded-2xl sm:rounded-2xl border-1 border-white bg-transparent backdrop-blur-xl sm:backdrop-blur-3xl shadow-[4px_4px_4px_1px_rgba(0,0,0,0.25),inset_0_4px_4px_0_rgba(0,0,0,0.25)]";
    ...
    const centerButtonCardStyle = "inline-flex relative max-xxs:w-25 max-xxs:h-11  xxs:w-29 xxs:h-11 xs:w-32 xs:h-11 sm:w-58 sm:h-15 overflow-hidden rounded-2xl sm:rounded-[20px] p-[1px] focus:outline-none focus:ring-2 focus:ring-[#000000] focus:ring-offset-1 focus:ring-offset-[#242424] backdrop-blur-md shadow-[4px_4px_4px_1px_rgba(0,0,0,0.25),inset_0_4px_4px_0_rgba(0,0,0,0.25)]";
    ...
    const centerButtonTextStyle = "inline-flex h-full w-full items-center justify-center rounded-2xl sm:rounded-[20px] bg-black px-1 max-xxs:text-[14px] xxs:text-[14px] xs:text-base sm:text-[20px] text-[#b43777] font-semibold backdrop-blur-3xl";
    // Hover //
