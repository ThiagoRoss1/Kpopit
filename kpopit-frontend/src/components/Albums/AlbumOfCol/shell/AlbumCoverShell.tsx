...
import { COVER_PALETTE } from '../albumConstants';
import { HorizontalWaves, VectorCircle } from './AlbumDecorShapes';
import { TextureLighting, GrainParticles, CoverInsetShadow } from './AlbumTextures';
...
function CoverDecor() {
    return (
        <>
            ...
            {/* Vector circle, top corner */}
            <div aria-hidden className="absolute -top-53 left-54.75 h-120.75 w-120">
                <VectorCircle color={COVER_PALETTE.main} className="size-full rotate-90" />
            </div>
