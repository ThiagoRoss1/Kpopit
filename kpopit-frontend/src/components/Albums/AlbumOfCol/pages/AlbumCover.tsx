    ...
    return (
        <AlbumCoverShell spine="hardcover-left">
            <div className="absolute inset-0 flex items-center justify-center">
                <div className="flex h-120 w-95 flex-col items-center justify-center rounded-br-[80px] rounded-tl-[80px] bg-[#d9d9d9] px-10.25 
                drop-shadow-[2px_-2px_3px_rgba(0,0,0,0.3)]">
