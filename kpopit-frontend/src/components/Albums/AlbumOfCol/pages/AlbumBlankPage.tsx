        ...
        <AlbumContentShell groupName={group.group_name} palette={group.palette} side="right">
            <AlbumMembersFrame group={group} pageLabel={pageLabel}>
                <div className="z-20 flex flex-col items-center gap-3 self-center">
                    <div className={`flex h-25 w-full flex-col items-center justify-center rounded-br-[20px] rounded-tl-[20px] bg-[#2d2d2d] p-6`}>
                        <div className="font-major-mono-display flex flex-col items-center whitespace-nowrap text-center text-[32px] leading-[normal] 
                        text-(--album-light) drop-shadow-[2px_2px_1px_rgba(0,0,0,0.5)]">
