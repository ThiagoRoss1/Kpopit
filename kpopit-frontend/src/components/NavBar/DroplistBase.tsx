...
const DroplistBase = (props: DroplistBaseProps) => {
    ...
    return (
        <div 
            ...
            className={`droplist-base absolute top-full max-3xl:left-1/2 max-3xl:-translate-x-1/2 3xl:left-0 3xl:translate-x-0 mt-3 z-50 bg-black/80 border border-white/10 rounded-2xl  
